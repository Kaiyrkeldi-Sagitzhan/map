...
export default function ViewerSearchResults() {
    ...
    return (
        <div className="fixed top-28 left-[330px] z-[1000] w-72 max-h-[50vh] bg-[#020C1B]/95 backdrop-blur-3xl rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] border border-white/10 flex flex-col pointer-events-auto animate-in fade-in slide-in-from-left-2 duration-200">
            {/* Header */}
